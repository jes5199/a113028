...
| 61 | 2159432391576551378277658181546813434552677183954783130085487155062653805766432381530957181202633703075200 | **verified lower bound — maximum within the W=23 window** (not STRONG: full maximality open) | 1245.1s (child16 of 23) | **SUPERSEDED the |D|=58 WEAK value** (106 digits vs 104; 59 base-61 digits vs 58, so strictly larger). Forced set drops {30}. b61 was the only §8 base still on the DISCOVERY side: its old incumbent had 58 digits against a 59-digit forced set, so no lex cutoff could fire — the incumbent was one digit too short to prune anything. Restoring {43,47} multiplies L_eff by exactly 43*47=2021; the value satisfies lcm=9690712164777231700912800, the forced set's L_eff. FOUND by exact decomposition of the W=23 terminal into 23 checkpointed W=22 children (fix descending top-35, position 36 over the 24 remaining digits); children ran in strictly descending pos36 order, so the hit at pos36=8 is preceded by contiguous refutations at 24..9 and the 5 unrun children are lex-smaller — maximal within the window, nothing lost by stopping. See b61_decomposition/POS36_COVERAGE.md. |
